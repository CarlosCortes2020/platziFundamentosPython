...
class RockPaperScissors:
    def __init__(self, root):
        ...
        self.canvas.create_text(300, 200, text="Selecciona Piedra, Papel o Tijera", font=("Arial", 24), fill="black")
        self.canvas.create_text(300, 250, text="¡Suerte!", font=("Arial", 24), fill="black")
    ...
    def rock(self):
        ...
        self.display_message(user_choice, computer_choice, result)
    ...
    def display_message(self, user_choice, computer_choice, winner_message):
        ...
        self.canvas.create_image(200, 150, image=user_img)
        self.canvas.create_image(400, 150, image=computer_img)
        # Muestra los mensajes en el centro del lienzo en dos líneas diferentes
        self.canvas.create_text(200, 200, text=user_choice, font=("Arial", 24), fill="black")
        self.canvas.create_text(400, 200, text=computer_choice, font=("Arial", 24), fill="black")
