...
class RockPaperScissors:
    def __init__(self, root):
        ...
        self.root.geometry("700x700")  # Establece el tamaño de la ventana a 600x600 píxeles
    ...
    def rock(self):
        ...
        self.display_message(f"Elegiste {user_choice}.", f"Computadora eligió {computer_choice}.")
    ...
    def display_message(self, user_message, computer_message):
